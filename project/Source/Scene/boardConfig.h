...
#define MAX_STRICK_POWER   45000
#define MAX_COIN_VELOCITY   800
#define MAX_COIN_VELOCITYx   ITOX(MAX_COIN_VELOCITY)

#define STRICKER_MASSx FTOX(0.5f)
#define STRICKER_FRICTIONx FTOX(0.6f) //FTOX(0.019f)
#define STRICKER_BOUNCE_FACTORx FTOX(0.09f) //FTOX(0.09f)
#define COIN_MASSx FTOX(0.45f)
#define COIN_FRICTIONx FTOX(0.75f);     //FTOX(0.05f);
#define COIN_BOUNCE_FACTORx FTOX(0.001f) //FTOX(0.09f)
//
